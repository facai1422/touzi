      ...
      <div style={{ padding: '1rem' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.875rem', color: '#111827', lineHeight: '1.6' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              &ldquo;做健康产业创新的领航者&rdquo;为企业愿景，秉承&ldquo;团结、创新、卓越、共赢&rdquo;的核心价值观，公司多年来与北京大学、清华大学、北京化工大学、中国医学科学院药物研究所、哥伦比亚大学等多家科研机构建立广泛且深入的产学研合作。
            </p>
            <p style={{ marginBottom: '1rem' }}>
              以&ldquo;新工艺、新制剂、新药物&rdquo;为企业的主要发展方向和核心竞争力，公司现拥有以中国GMP、欧盟GMP及美国FDA cGMP为标准建设的多条世界先进产品生产线。为扩大生产规模，公司于2009年7月启动投资二期项目建设，从欧美引进世界先进的生产设备，运用世界领先的MES管理系统，建成了小容量无菌制剂、冻干/水针、原料药、大输液、固体制剂等多条国际先进工艺的生产车间。
            </p>
            <p style={{ marginBottom: '1rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              企业已获得科技部&ldquo;十二·五&rdquo;重大新药创制专项、北京市科委双十计划项目、重大科技攻关项目及北京市高成长企业资助创新科技专项等多项政府资助。获得了北京新药创制产学研联盟共建单位、北京药品安全百千万工程药品质量管理示范企业和北京市专利示范单位等多项荣誉。
            </p>
            <p>
